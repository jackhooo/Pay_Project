...
var projects:[Project] = [
    ...
    Project(projectName:"台南旅遊",members:membersList3, membersDetail: membersDetailList3,items: itemsList3, check: false, month: 5, date: "04", itemsDetail: itemsDetailList3),
